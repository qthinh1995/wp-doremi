...
<body class="<?php echo trim($classesReturn); ?>">
	...
	<div id="leftAreaEditor">
		...
		<div id="cssEditorBar">
			...
			<span class="editor-tabs single-tab" title="The styles applied to the current page." data-type-value="single">Single<span class="pro-tb">Pro</span><i></i></span>
			<span class="editor-tabs template-tab" title="The styles applied to all pages of the current post type." data-type-value="template">Template<span class="pro-tb">Pro</span><i></i></span>
	...
	<div class="yp-info-modal">
		...
		<div class="yp-info-modal-top-inner">
			<h2>Get YellowPencil Pro Today!</h2>
			<p>Reach many assets with one click. Continue to customize the pages without any restrictions.</p>
		</div>
		<ul>
			<li>Access 800+ Quality Fonts</li>
			<li>Stock images & pattern library</li>
			<li>Gradient backgrounds & color palettes</li>
			<li>Activate single and template customizations</li>
			<li>Customize WordPress login pages</li>
			<li>Six months premium support</li>
	...
	(function($){
        ...
        function auto_load_popup(){
	        ...
	        // Getting vars
	        var page_mode = '<?php echo $_GET["yp_mode"]; ?>';
		...
		$(document).ready(function(){
	        ...
	        $('#iframe').on('load', function(){
				...
				var scripts   = [
					...
					// Addons
					"<?php echo includes_url( 'js/jquery/ui/resizable.min.js' , __FILE__ ); ?>", // for resize panels also animate manager etc
		        ...
		        function yp_start_editor(){
		            ...
		            $("#yp-customizing-type-frame").on("load", function(){
            			body.addClass("yp-yellow-pencil yp-yellow-pencil-loaded");
