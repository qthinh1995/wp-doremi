...
function yp_get_slider_markup($cssName, $name, $default = 'inherit', $decimals, $pxv, $pcv, $emv, $note = null, $dataFormats){
    ...
    // Option HTML
    return "<div id='" . $cssName . "-group' class='yp-option-group yp-slider-option' data-support-formats='".$dataFormats."' data-css-default='".$default."' data-css='" . $cssName . "' data-css-id='" . yp_css_id($cssName) . "' data-decimals='" . $decimals . "' data-px-range='" . $pxv . "' data-pc-range='" . $pcv . "' data-em-range='" . $emv . "'><div class='yp-part'><label class='yp-option-label'><span".$tooltip.">" . $name . "</span><i class='phone-icon'></i><a class='yp-btn-action yp-disable-btn'></a></label><div id='yp-" . $cssName . "' class='yp-slider-div'></div><div class='yp-after'><input type='text' id='" . $cssName . "-value' class='yp-after-css yp-after-css-val' autocomplete='off' autocorrect='off' autocapitalize='off' spellcheck='false' /><input type='text' id='" . $cssName . "-after' class='yp-after-css yp-after-prefix' autocomplete='off' autocorrect='off' autocapitalize='off' spellcheck='false' /></div></div><div class='clearfix'></div><div class='prefix-select'></div></div>";
...
function yp_get_select_markup($cssName, $name, $values, $default = 'none', $note = null){
    ...
    // Option HTML
    $return = "<div id='" . $cssName . "-group' class='yp-option-group yp-select-option' data-css='" . $cssName . "' data-css-id='" . yp_css_id($cssName) . "'><div class='yp-part'><label class='yp-option-label'><span".$tooltip.">" . $name . "</span><i class='phone-icon'></i> " . $defaultLink . " <a class='yp-btn-action yp-disable-btn'></a></label><textarea tabindex='-1' autocomplete='off' autocorrect='off' autocapitalize='off' spellcheck='false' disabled='disabled'>".$values."</textarea>";
...
function yp_get_radio_markup($cssName, $name, $values, $default = 'none',$note = null){
    ...
    // Option HTML
    $return = "<div id='" . $cssName . "-group' class='yp-option-group yp-radio-option' data-css='" . $cssName . "' data-css-id='" . yp_css_id($cssName) . "'><div class='yp-part'><label class='yp-option-label'><span".$tooltip.">" . $name . "</span><i class='phone-icon'></i> " . $defaultLink . " <a class='yp-btn-action yp-disable-btn'></a></label><div class='yp-radio-grid-" . count($values) . " yp-radio-content' id='yp-" . $cssName . "'>";
