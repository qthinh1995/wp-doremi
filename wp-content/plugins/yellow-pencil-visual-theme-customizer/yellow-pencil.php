...
function yp_customizing_options(){
    ...
    // Options
    $result = "<li data-value='single' class='".$singleSelected."'><i class='manage-this-type'></i><i class='reset-this-type'></i><h6><span>Single Customization</span><span class='pro-cus-type'>PRO</span><small class='type-bayt'><span>empty</span><i>changed</i></small></h6><span class='current-type'>current</span><p>apply style just to the current page.</p></li>";
    $result .= '<li data-value="template" class="'.$templateSelected.'"><i class="manage-this-type"></i><i class="reset-this-type"></i><h6><span>Template Customization</span><span class="pro-cus-type">PRO</span><small class="type-bayt"><span>empty</span><i>changed</i></small></h6><span class="current-type">current</span><p>apply style to all pages of the current post type.</p></li>';
...
function yp_yellow_pencil_edit_admin_bar($bar) {
    ...
    // WTFV, use global instead of single
    if(defined("WTFV") == false){
        $global_option = "1";
    }
    ...
    // use global instead of template if wtfv.
    if(defined("WTFV") == false && $edit_mode == "template"){
        $edit_mode = "global";
    }
